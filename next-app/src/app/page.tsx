        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-12">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="text-xl font-extrabold tracking-tight text-[#1fc94f]">DeClut</span>
            </Link>
          ...
          <div className="flex flex-1 justify-end items-center gap-6">
            <div className="hidden lg:flex w-full max-w-xs relative">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#3f7953] text-xl">
                search
              </span>
              <input
                className="w-full bg-[#f0f4f2] border-none rounded-xl py-2.5 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary/20 placeholder:text-[#438058]"
      ...
      <main className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-8 order-2 lg:order-1">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-lg lg:text-xl text-[#1cb853] leading-relaxed max-w-xl">
              ...
              <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden shadow-2xl bg-gradient-to-br from-gray-200 to-gray-300">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur px-6 py-5 rounded-2xl flex justify-between items-center shadow-lg border border-white/20">
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-[#267e44] uppercase tracking-wider">Top Curated Pick</span>
        ...
        <section className="px-6 lg:px-20 py-8 bg-white border-y border-[#dbe6df]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center gap-1">
              ...
              <span className="text-sm font-semibold text-[#258b49]">Items Rehomed</span>
            </div>
            <div className="flex flex-col items-center text-center gap-1">
              <span className="text-3xl font-black text-[#111813]">500k</span>
              <span className="text-sm font-semibold text-[#1d8f45]">Liters of Water Saved</span>
            </div>
            <div className="flex flex-col items-center text-center gap-1">
              <span className="text-3xl font-black text-[#111813]">25k</span>
              <span className="text-sm font-semibold text-[#25914b]">kg CO2 Reduced</span>
            </div>
            <div className="flex flex-col items-center text-center gap-1">
              <span className="text-3xl font-black text-[#111813]">150+</span>
              <span className="text-sm font-semibold text-[#2c9752]">Partner Charities</span>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 lg:px-20 py-20 bg-background-light">
          <div className="flex flex-col gap-12">
            <div className="max-w-2xl">
              ...
              <p className="text-[#2b8f4e] text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group p-8 bg-white rounded-3xl border border-[#dbe6df] hover:border-primary transition-all hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-[#319453] leading-relaxed mb-6">
              ...
              <div className="group p-8 bg-white rounded-3xl border border-[#dbe6df] hover:border-primary transition-all hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-[#319253] leading-relaxed mb-6">
              ...
              <div className="group p-8 bg-white rounded-3xl border border-[#dbe6df] hover:border-primary transition-all hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-[#359657] leading-relaxed mb-6">
        ...
        <section className="px-6 lg:px-20 py-20 bg-white">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-[#2c8a4c] text-lg">Fresh arrivals from the most conscious closets.</p>
            </div>
            <Link
              href="/shop"
        ...
        <section className="px-6 lg:px-20 py-20">
          <div className="bg-primary/10 rounded-[3rem] p-8 lg:p-20 relative overflow-hidden flex flex-col items-center text-center gap-8">
            ...
            <p className="text-[#2c9450] text-lg max-w-xl">
            ...
            <p className="text-xs text-[#318f52]">No spam, just sustainability. Unsubscribe at any time.</p>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-white border-t border-[#dbe6df] px-6 lg:px-20 py-16">
        <div className="max-w-[1440px] mx-auto grid grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="col-span-2 lg:col-span-2 flex flex-col gap-6">
            ...
            <p className="text-[#238846] max-w-xs leading-relaxed">
        ...
        <div className="max-w-[1440px] mx-auto mt-16 pt-8 border-t border-[#f0f4f2] flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-[#2f834d]">© 2024 DeClut Marketplace. All rights reserved.</p>
          <div className="flex gap-6">
            <Link href="/privacy" className="text-xs text-[#318f52] hover:text-primary transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-xs text-[#2c8a4c] hover:text-primary transition-colors">
              Terms of Service
            </Link>
            <Link href="/cookies" className="text-xs text-[#309453] hover:text-primary transition-colors">
              Cookie Settings
            </Link>
          </div>
        </div>
    ...
    <div className="group cursor-pointer">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-[#2b854a]">
            {brand} · Size {size}
          </p>
        </div>
...
function FooterColumn({ title, links }: FooterColumnProps) {
  return (
    <div className="flex flex-col gap-4">
      ...
      {links.map((link) => (
        <Link key={link.href} href={link.href} className="text-sm text-[#329454] hover:text-primary transition-colors">
          {link.label}
        </Link>
      ))}
    </div>
